...
// Lead with a UTF-8 BOM (﻿) so browsers reliably detect the encoding
// even when Cloudflare serves the file without an explicit charset.
...
window.KLINE = {
  ...
  formatUGX:  (n) => 'UGX ' + n.toLocaleString('en-UG'),
